        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            ...
            <div class="navbar-nav">
                <div class="nav-item text-nowrap">
                    ...
                    @else
                        <a class="nav-link px-3" href="{{ route('BackEnd.dang-nhap') }}">Xin chào, hãy đăng nhập</a>
                    @endauth
                </div>
            </div>
        </header>
            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3 sidebar-sticky">
                        ...
                        <li class="nav-item @if(Route::is('BackEnd.quan-li-san-pham.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-san-pham.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-danh-muc-san-pham.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-danh-muc-san-pham.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-nha-cung-cap.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-nha-cung-cap.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-don-hang.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-don-hang.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-binh-luan.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-binh-luan.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-khach-hang.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-khach-hang.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-nhan-vien.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-nhan-vien.index')}}">
                            ...
                            <li class="nav-item @if(Route::is('BackEnd.quan-li-tai-khoan-admin.index')) active @endif">
                                <a class="nav-link" href="{{route('BackEnd.quan-li-tai-khoan-admin.index')}}">
